...
class CallHistoryVC: UIViewController {
    ...
    @IBOutlet weak var pCallBtn: UILabel!
    ...
    override func viewDidLoad() {
       ...
       // loadCallLogDetail()
        ...
        if ifComeforPUsge {
            ...
            self.callSelectionView.visibility = .visible
        }else{
             loadCallLogDetailForUncategoryCall()
            self.pUsageLbl.text = "Uncategorized Calls"
            self.callSelectionView.visibility = .gone
        }
...
public class sortData{
    static var instance = sortData()
    var sortType = 0
//    0 FOR TODAY 1 FOR WEEKLY 2 MONTHLY
}
